...
//Fonction principale
function init() {
	fetch("https://api.open-meteo.com/v1/forecast?latitude=48.74&longitude=-3.47&timezone=auto&current_weather=true&hourly=temperature_2m,relativehumidity_2m,windspeed_10m") //API avec coordonnées de Rennes
